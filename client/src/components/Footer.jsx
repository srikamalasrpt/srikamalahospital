...
import { Facebook, Twitter, Instagram, Mail, Phone, MapPin, ExternalLink, Globe, ShieldCheck, Award } from 'lucide-react';
        ...
        <footer className="bg-hospital-dark pt-20 pb-10 px-6 relative overflow-hidden text-white font-sans">
            ...
            <div className="container mx-auto max-w-7xl relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-400 text-xs font-medium leading-relaxed max-w-sm">
                           Reliable healthcare and talented consultancy in Suryapet. Available 24 hours for emergency and regular treatment.
                        </p>
                    </div>

                    {/* Navigation Quicklinks */}
                    <div className="space-y-6">
                        <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-hospital-secondary font-['Noto_Sans_Telugu'] text-sm">త్వరిత నావిగేషన్</h4>
                    ...
                    {/* Contact Info Grid */}
                    <div className="space-y-6">
                        <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-hospital-secondary font-['Noto_Sans_Telugu'] text-sm">సంప్రదించండి</h4>
                        <div className="space-y-4">
                            <div className="flex gap-3">
                               ...
                               <div><p className="text-[10px] font-bold text-gray-300 font-['Noto_Sans_Telugu'] uppercase">మానస నగర్, సూర్యాపేట</p><p className="text-[7px] uppercase font-black tracking-widest text-gray-500">Manasa Nagar, Suryapet, 508213</p></div>
                            </div>
                            <div className="flex gap-3">
                               <div className="w-8 h-8 bg-white/5 rounded-xl flex items-center justify-center text-hospital-primary"><Phone size={16} /></div>
                               <div><p className="text-[10px] font-bold text-gray-300">099480 76665</p><p className="text-[7px] uppercase font-black tracking-widest text-gray-500">24/7 Support Line</p></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-hospital-secondary font-['Noto_Sans_Telugu'] text-sm">గుర్తింపు</h4>
                        <div className="flex gap-3">
                ...
                <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-center">
                    <p className="text-[8px] font-black text-gray-500 uppercase tracking-widest">© 2026 SRI KAMALA HOSPITAL. ALL RIGHTS RESERVED.</p>
                </div>
            </div>
        </footer>
    );
