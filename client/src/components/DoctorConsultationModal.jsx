...
const DoctorConsultationModal = ({ isOpen, onClose, doctor }) => {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const prompt = `You are the digital medical assistant for ${doctor.name}, a specialist in ${doctor.specialty} at Sri Kamala Hospital (Contact: 99480 76665, 98668 95634, MG Road, Suryapet). Answer the patient's inquiry: "${userMsg.text}". Be empathetic, concise (max 3 sentences), and advise booking an appointment if clinical intervention is needed.`;
